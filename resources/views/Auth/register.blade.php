            ...
            <div>
                <div class="container-login100">
                    <div class="card  wrap-login100 p-0">
                        <div class="card-body">
                            <form class="login100-form validate-form form-register" action="{{ route('register.post') }}" method="POST">
                                @csrf
                                ...
                                <div class="wrap-input100 validate-input">
                                    <input type="text" class="form-control input100"
                                        id="name" placeholder="Nhập họ và tên..." name="name" value="{{ old('name') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M4 22a8 8 0 1 1 16 0zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6s6 2.685 6 6s-2.685 6-6 6"/></svg>
                                    </span>
                                </div>
                                ...
                                <div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="email" class="form-control input100"
                                        id="floatingPassword" placeholder="Địa chỉ Email" name="email" value="{{ old('email') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1m9.06 8.683L5.648 6.238L4.353 7.762l7.72 6.555l7.581-6.56l-1.308-1.513z"/></svg>
                                    </span>
                                </div>
								<div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="text" class="form-control input100"
                                        id="floatingInput" placeholder="Tài khoản đăng nhập" name="username" value="{{ old('username') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M14.256 21.744L12 24l-2.256-2.256C5.31 20.72 2 16.744 2 12C2 6.48 6.48 2 12 2s10 4.48 10 10c0 4.744-3.31 8.72-7.744 9.744m-8.233-6.328C7.491 17.606 9.695 19 12.16 19s4.669-1.393 6.136-3.584A8.97 8.97 0 0 0 12.16 13a8.97 8.97 0 0 0-6.137 2.416M12 11a3 3 0 1 0 0-6a3 3 0 0 0 0 6"/></svg>
                                    </span>
                                </div>
								<div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="password" class="form-control input100"
                                        id="floatingPassword" placeholder="Mật khẩu đăng nhập" name="password" value="{{ old('password') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
								...
								<div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="password" class="form-control input100"
                                        id="floatingPassword" placeholder="Xác nhận mật khẩu đăng nhập" name="password_confirmation" value="{{ old('password') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M19 10h1a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V11a1 1 0 0 1 1-1h1V9a7 7 0 0 1 14 0zm-2 0V9A5 5 0 0 0 7 9v1zm-6 4v4h2v-4z"/></svg>
                                    </span>
								...
								<div class="fv-row mb-8">
									<label class="form-check form-check-inline">
										...
										<span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">Tôi đồng ý
											với
                                ...
                                <div class="d-grid mb-10">
                                    <button type="submit" id="kt_sign_in_submit"
                                        ...
                                        <span class="indicator-label">Đăng ký Ngay</span>
                                    </button>
                                </div>
                                <!--end::Submit button-->
                                ...
                                <div class="text-center pt-3">
                                    <p class="text-dark mb-0">Đã có tài khoản? <a href="{{ route('login') }}"
                                            class="text-primary ms-1">Đăng nhập ngay</a></p>
                                </div>
                                <!--end::Sign up-->
                            </form>
                        </div>
