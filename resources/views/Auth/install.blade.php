...
<head>
    ...
    <!-- Meta Data -->
    <title>Kích hoạt vào hệ thống</title>
    <!--  Required Meta Tag -->
                        ...
                        <div class="card-body">
                            ...
                            @if (getDomain() != env('PARENT_SITE'))
                                ...
                                <div class="wrap-input100 validate-input">
                                    <input type="text" class="form-control input100" name="api_token"
                                        id="floatingInput" placeholder="API KEY Web Chính" value="{{ old('api_token') }}">
                                ...
                                <div class="wrap-input100 validate-input">
                                    <input type="text" class="form-control input100" name="name"
                                        id="floatingInput" placeholder="Họ và tên" value="{{ old('name') }}">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 24 24">
                                ...
                                <div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="email" class="form-control input100" name="email"
                                        id="floatingPassword" placeholder="Địa chỉ Email" value="">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 24 24">
                                ...
                                <div class="wrap-input100 validate-input" data-bs-validate="Password is required">
                                    <input type="password" class="form-control input100" name="password_confirmation"
                                        id="floatingPassword" placeholder="Nhập Lại Mật khẩu truy cập" value="">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 24 24">
