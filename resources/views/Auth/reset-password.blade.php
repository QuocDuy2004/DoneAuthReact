...
<head>
    ...
    <link rel="stylesheet" href="https://smmpanel-v3.baocms.net/assets/libs/@simonwep/pickr/themes/nano.min.css">
    ...
    <link rel="preload" as="style" href="/build/assets/app-DjhSsAid.css">
    <link rel="stylesheet" href="/build/assets/app-DjhSsAid.css">
    <style>
        :root {
            --primary: #0063cc;
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0">
                <div class="d-flex flex-center flex-lg-start flex-column">
                    <img alt="FBVN" src="{{ DataSite('image_seo') }}" class="w-225px" />
                </div>
            </div>
                        ...
                        <form action="{{ route('reset.password.post', $token->token) }}" method="POST" class="w-100">
                            ...
                            <div class="form-floating mb-5">
                                <input type="password" class="form-control" id="floatingInput"
                                    placeholder="Nhập địa chỉ email..." name="password" value="">
                                <label for="floatingInput">Mật Khẩu Mới</label>
                            </div>
                            <div class="form-floating mb-5">
                                <input type="password" class="form-control" id="passwordNewConfirm"
                                    placeholder="Nhập địa chỉ email..." name="password_confirmation"
                                    value="{{ old('password_confirmation') }}">
                                <label for="passwordNewConfirm">Xác Nhận Mật khẩu</label>
                            </div>
                            <div class="row mb-9">
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-default">Khôi Phục Mật Khẩu</button>
                                </div>
                                <div class="separator separator-content border-secondary my-5"><span
                                        class="w-50px text-gray">hoặc</span></div>
                                <div class="d-grid">
